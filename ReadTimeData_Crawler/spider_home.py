...
class SpiderMain(object):
    ...
    def craw(self,root_url):
        ...
        while self.urls.hasNewUrls():
            try:
                new_url=self.urls.getNewUrls()
                html_content=self.downloader.doDownLoad(new_url)
                # print html_content
                datas=self.parse.doParse(html_content)
                # self.urls.addNewUrls(new_urls)
                self.outputer.doCollectData(datas)
            except Exception ,e:
                print "craw failed!!!!!!!"
                print e
...
if __name__=="__main__":
    ...
    #首页轮播图
    root_home_url_lunbotu="http://yuedu.163.com/news_reader#/!/source?id=16f9a42d-7385-4ea4-b3ac-05041fe40ffc_1&cid=348a20cca16446eda2e8e21b93eb3a8a_1"
    #专题
