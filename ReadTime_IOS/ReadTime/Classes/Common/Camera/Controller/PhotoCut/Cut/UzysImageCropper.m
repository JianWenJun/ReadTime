...
- (id)initWithImage:(UIImage*)newImage andframeSize:(CGSize)frameSize andcropSize:(CGSize)cropSize
{
    ...
    if(self)
    {
        ...
        UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, _cropRect.origin.y)];
        ...
        UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, _cropRect.origin.y + _cropRect.size.height, SCREEN_WIDTH, (CONTENT_HEIGHT - _cropRect.size.height)/2)];
